...
# Official DeepSeek-V4-Flash-0731 reasoning-effort prefixes. In thinking mode,
# the selected prefix is prepended at the beginning of the conversation.
# `low` is the default and adds nothing.
